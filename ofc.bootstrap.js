...
const GA_MEASUREMENT_ID = "G-8LKTVQD8EJ";
...
function gtag_report_conversion(url) {
  ...
  gtag("event", "conversion", {
    send_to: "AW-17975933627/d98fCPbo1tkbEL_XrrZC",
    value: 0.1,
    currency: "AED",
...
(async function initDisplayAds() {
  ...
  const adSlots = [
    { adUnit: "/23330730517/playnexa4.in_d1", divId: "myw_top_1" },
    { adUnit: "/23330730517/playnexa4.in_d2", divId: "myw_top_2" },
    { adUnit: "/23330730517/playnexa4.in_d3", divId: "myw_top_3" },
  ];
    ...
    googletag.cmd.push(function () {
      try {
        ...
        currentSlot = googletag
          .defineOutOfPageSlot(
            "/23330730517/playnexa4.in_reward",
